  ...
  return (
    <section id="designs">
       <div className="text-center mb-12 md:mb-16">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Design Templates</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {designTemplates.map((template, index) => (
          <div key={index} className="glass-card rounded-2xl overflow-hidden group">
            ...
            <div className="p-6">
              <h3 className="text-lg md:text-xl font-bold text-white mb-2">{template.title}</h3>
