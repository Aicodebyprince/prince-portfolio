    ...
    return (
        <section id="all-experiences">
            <div className="text-center mb-12 md:mb-16">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">My Professional Experience</h1>
                ...
                {experiences.map((exp, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 md:p-8 group">
                        <div className="flex flex-col md:flex-row justify-between md:items-center mb-4">
                             ...
                             <div className="text-sm md:text-md text-[var(--wt-teal)] font-semibold mt-2 md:mt-0">{exp.period}</div>
                        </div>
