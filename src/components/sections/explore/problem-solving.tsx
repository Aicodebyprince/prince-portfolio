    ...
    return (
        <section id="problem-solving">
            <div className="text-center mb-12 md:mb-16">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Problem Solving Showcase</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {problemSolving.map((item, index) => (
                     <div key={index} className="glass-card rounded-2xl p-6 md:p-8 flex flex-col group">
                        <div className="flex-grow">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="bg-white/10 p-4 rounded-lg">
                                    {iconMap[item.platform] || <Check className="w-6 h-6 text-gray-400" />}
                                </div>
                                <h3 className="text-xl md:text-2xl font-bold text-white">{item.platform}</h3>
                            </div>
                            <div className="mb-4">
