    ...
    return (
        <div className="w-full my-16">
            <div className="text-center mb-10 max-w-2xl mx-auto">
                <div className="w-16 h-16 bg-gradient-to-br from-[rgba(216,162,77,0.18)] to-[rgba(57,215,197,0.18)] rounded-2xl flex items-center justify-center mx-auto mb-6 border border-white/10">
