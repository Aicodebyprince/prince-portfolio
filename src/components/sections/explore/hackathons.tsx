    ...
    return (
        <section id="hackathons">
            <div className="text-center mb-12 md:mb-16">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Hackathon Achievements</h1>
                ...
                {hackathons.map((hackathon, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 md:p-8 group">
                        <div className="flex flex-col md:flex-row justify-between md:items-center mb-4">
                            <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-accent transition-colors">{hackathon.name}</h3>
                            <div className="text-sm md:text-md text-gray-400 font-semibold mt-2 md:mt-0 flex items-center">
