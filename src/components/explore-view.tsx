  ...
  return (
    <div className="bg-black text-white h-screen w-screen flex antialiased overflow-hidden">
      ...
      <main className="flex-grow overflow-y-auto relative pb-20 md:pb-0">
        ...
        {/* Mobile Back Button */}
        <div className="md:hidden p-4 sticky top-0 bg-black/50 backdrop-blur-sm z-10">
             <Button onClick={() => router.push('/')} variant="ghost" className="hover:bg-white/10">
      ...
      {/* Mobile Bottom Bar */}
       <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 z-20 bg-black/70 backdrop-blur-lg border-t border-white/10">
            ...
            <div className="flex h-full items-center px-2">
              {navItems.map(item => (
                <button
                  ...
                  onClick={() => handleTabChange(item.id)}
                  className={cn(
                    "flex flex-col items-center justify-center h-full px-3 transition-colors flex-shrink-0",
