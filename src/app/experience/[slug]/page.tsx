            ...
            <div className="relative z-10 p-4 md:p-12">
                <div className="max-w-4xl mx-auto">
                    ...
                    <header className="mb-12 text-center">
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-2 gradient-text">{experience.role}</h1>
                        <p className="text-xl md:text-2xl text-gray-300 font-semibold">{experience.company}</p>
                        <p className="text-md md:text-lg text-[var(--wt-teal)] mt-2">{experience.period}</p>
                    </header>
